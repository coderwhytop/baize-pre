import type { PluginInstance } from "@/types/interface/plugin.interface";
...
export class PluginService implements PluginInstance {
  ...
  private getBuiltinPlugins(): TYPE_PLUGIN_ITEM[] {
    ...
    const projectLintStagedConfig = this.readProjectConfig(
      "lint-staged.config.mjs",
    );

    // Prettier 插件
    const prettierConfigContent =
      projectPrettierConfig || configs.prettier.content;
