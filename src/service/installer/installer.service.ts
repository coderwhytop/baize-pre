import type { InstallerInstance } from "@/types/interface/installer.interface";
import type { LoggerInstance } from "@/types/interface/logger.interface";
import type { NodeInstance } from "@/types/interface/node.interface";
import type { PackageInstance } from "@/types/interface/package.interface";
import type { ToolInstance } from "@/types/interface/tool.interface";
import type { TYPE_MANAGER_NAME } from "@/types/type/manager.type";
    ...
    const question = [
      {
        type: "list",
        name: questionKey,
        message: `${chalk.cyan("◆")} ${chalk.bold("Which package manager to use?")}`,
    ...
    const question = [
      {
        type: "list",
        name: "framework",
        message: `${selectedInfo + chalk.blue("◆")} ${chalk.bold(
          "Select a variant:",
        )}`,
        choices: [
    ...
    const question = [
      {
        type: "checkbox",
        name: "plugins",
        message: `${chalk.cyan("◆")} ${chalk.bold("Select plugins to install:")}`,
